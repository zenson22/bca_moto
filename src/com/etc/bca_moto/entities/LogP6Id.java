 ...
 */
@Embeddable
public class LogP6Id implements java.io.Serializable {
	...
	@Column(name = "BIEN_SO", columnDefinition = "VARCHAR2")
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof LogP6Id))
			return false;
		LogP6Id castOther = (LogP6Id) other;

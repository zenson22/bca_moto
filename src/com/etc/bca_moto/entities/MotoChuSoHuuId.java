 ...
 */
@Embeddable
public class MotoChuSoHuuId implements java.io.Serializable {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MotoChuSoHuuId))
			return false;
		MotoChuSoHuuId castOther = (MotoChuSoHuuId) other;

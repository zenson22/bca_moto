...
import com.etc.bca_moto.dal.TamGiuQd18DAO;
 ...
 * TamGiuQd18
 */
@DAO(daoClass = TamGiuQd18DAO.class)
@Caption("{%loaiTvtg}")
@Entity
@Table(name = "TAM_GIU_QD18", schema = "BCA_MOTO")
public class TamGiuQd18 implements java.io.Serializable {

...
import com.etc.bca_moto.dal.BbKhamNoiCatTv53DAO;
 ...
 * BbKhamNoiCatTv53
 */
@DAO(daoClass = BbKhamNoiCatTv53DAO.class)
@Caption("{%soBienBan}")
@Entity
@Table(name = "BB_KHAM_NOI_CAT_TV_53", schema = "BCA_MOTO")
public class BbKhamNoiCatTv53 implements java.io.Serializable {

...
import com.etc.bca_moto.dal.ViewBb60Tv60DAO;
 ...
 * ViewBb60Tv60
 */
@DAO(daoClass = ViewBb60Tv60DAO.class)
@Caption("{%id}")
@Entity
@Table(name = "VIEW_BB60_TV60", schema = "BCA_MOTO")
public class ViewBb60Tv60 implements java.io.Serializable {

	private ViewBb60Tv60Id id;
	...
	@AttributeOverrides({
			...
			@AttributeOverride(name = "ngayLapBbTl", column = @Column(name = "NGAY_LAP_BB_TL", columnDefinition = "DATE", length = 7)),
	...
	public ViewBb60Tv60Id getId() {
		return this.id;
	}

	public void setId(ViewBb60Tv60Id id) {
		this.id = id;
	}

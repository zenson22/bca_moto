...
import com.etc.bca_moto.dal.TamGiuBb53DAO;
 ...
 * TamGiuBb53
 */
@DAO(daoClass = TamGiuBb53DAO.class)
@Caption("{%loaiTvtg}")
@Entity
@Table(name = "TAM_GIU_BB53", schema = "BCA_MOTO")
public class TamGiuBb53 implements java.io.Serializable {

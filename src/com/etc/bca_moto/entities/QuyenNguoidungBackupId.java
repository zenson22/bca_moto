...
/**
 * QuyenNguoidungBackupId
 */
@Embeddable
public class QuyenNguoidungBackupId implements java.io.Serializable {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof QuyenNguoidungBackupId))
			return false;
		QuyenNguoidungBackupId castOther = (QuyenNguoidungBackupId) other;

 ...
 */
@Embeddable
public class ViewBb50Tv50Id implements java.io.Serializable {
	...
	@Column(name = "DAC_DIEM_TANG_VAT1", columnDefinition = "VARCHAR2", length = 500)
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ViewBb50Tv50Id))
			return false;
		ViewBb50Tv50Id castOther = (ViewBb50Tv50Id) other;

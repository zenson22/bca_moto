 ...
 */
@Embeddable
public class ViewQdtg18Tvtg18Id implements java.io.Serializable {
	...
	@Column(name = "SO_BIEN_BAN_18", nullable = false, columnDefinition = "NUMBER", precision = 30, scale = 0)
	public long getSoBienBan18() {
		return this.soBienBan18;
	}

	public void setSoBienBan18(long soBienBan18) {
		this.soBienBan18 = soBienBan18;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ViewQdtg18Tvtg18Id))
			return false;
		ViewQdtg18Tvtg18Id castOther = (ViewQdtg18Tvtg18Id) other;
		...
		return (this.getId() == castOther.getId())
				...
				&& (this.getIdTvtg() == castOther.getIdTvtg()) && (this.getSoBienBan18() == castOther.getSoBienBan18())
	...
	public int hashCode() {
		...
		result = 37 * result + (int) this.getSoBienBan18();

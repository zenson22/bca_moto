...
import com.etc.bca_moto.dal.TamGiuQd20DAO;
 ...
 * TamGiuQd20
 */
@DAO(daoClass = TamGiuQd20DAO.class)
@Caption("{%loaiTvtg}")
@Entity
@Table(name = "TAM_GIU_QD20", schema = "BCA_MOTO")
public class TamGiuQd20 implements java.io.Serializable {

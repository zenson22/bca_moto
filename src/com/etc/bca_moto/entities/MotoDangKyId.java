 ...
 */
@Embeddable
public class MotoDangKyId implements java.io.Serializable {
	...
	private Long seriSo;
	private String soTbDnchs;
	private Date ngayTbDnchs;
	private String maNopThueTruocBa;
	private Long soLanTraBien;
	...
	@Column(name = "SO_TB_DNCHS", columnDefinition = "VARCHAR2", length = 20)
	public String getSoTbDnchs() {
		return this.soTbDnchs;
	}

	public void setSoTbDnchs(String soTbDnchs) {
		this.soTbDnchs = soTbDnchs;
	}

	@Column(name = "NGAY_TB_DNCHS", columnDefinition = "DATE", length = 7)
	public Date getNgayTbDnchs() {
		return this.ngayTbDnchs;
	}

	public void setNgayTbDnchs(Date ngayTbDnchs) {
		this.ngayTbDnchs = ngayTbDnchs;
	}
	...
	@Column(name = "SO_LAN_TRA_BIEN", columnDefinition = "NUMBER", precision = 22, scale = 0)
	public Long getSoLanTraBien() {
		return this.soLanTraBien;
	}

	public void setSoLanTraBien(Long soLanTraBien) {
		this.soLanTraBien = soLanTraBien;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MotoDangKyId))
			return false;
		MotoDangKyId castOther = (MotoDangKyId) other;
		...
		return (this.getId() == castOther.getId()) && (this.getMotoId() == castOther.getMotoId())
				...
				&& ((this.getSoTbDnchs() == castOther.getSoTbDnchs()) || (this.getSoTbDnchs() != null
						&& castOther.getSoTbDnchs() != null && this.getSoTbDnchs().equals(castOther.getSoTbDnchs())))
				&& ((this.getNgayTbDnchs() == castOther.getNgayTbDnchs())
						|| (this.getNgayTbDnchs() != null && castOther.getNgayTbDnchs() != null
								&& this.getNgayTbDnchs().equals(castOther.getNgayTbDnchs())))
				...
				&& ((this.getSoLanTraBien() == castOther.getSoLanTraBien())
						|| (this.getSoLanTraBien() != null && castOther.getSoLanTraBien() != null
								&& this.getSoLanTraBien().equals(castOther.getSoLanTraBien())));
	}
	...
	public int hashCode() {
		...
		result = 37 * result + (getSoTbDnchs() == null ? 0 : this.getSoTbDnchs().hashCode());
		result = 37 * result + (getNgayTbDnchs() == null ? 0 : this.getNgayTbDnchs().hashCode());
		result = 37 * result + (getMaNopThueTruocBa() == null ? 0 : this.getMaNopThueTruocBa().hashCode());
		result = 37 * result + (getSoLanTraBien() == null ? 0 : this.getSoLanTraBien().hashCode());
		return result;
	}

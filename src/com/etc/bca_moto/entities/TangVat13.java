...
import com.etc.bca_moto.dal.TangVat13DAO;
 ...
 * TangVat13
 */
@DAO(daoClass = TangVat13DAO.class)
@Caption("{%loaiTvtg}")
@Entity
@Table(name = "TANG_VAT_13", schema = "BCA_MOTO")
public class TangVat13 implements java.io.Serializable {

...
import com.etc.bca_moto.dal.LsMotoChuSoHuuDAO;
 ...
 * LsMotoChuSoHuu
 */
@DAO(daoClass = LsMotoChuSoHuuDAO.class)
@Caption("{%id}")
@Entity
@Table(name = "LS_MOTO_CHU_SO_HUU", schema = "BCA_MOTO", uniqueConstraints = @UniqueConstraint(columnNames = { "ID",
		"MA_GIAO_DICH" }))
public class LsMotoChuSoHuu implements java.io.Serializable {

	private LsMotoChuSoHuuId id;

	public LsMotoChuSoHuu() {
	}
	...
	public LsMotoChuSoHuuId getId() {
		return this.id;
	}

	public void setId(LsMotoChuSoHuuId id) {
		this.id = id;
	}

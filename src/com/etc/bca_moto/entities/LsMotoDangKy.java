...
import com.etc.bca_moto.dal.LsMotoDangKyDAO;
 ...
 * LsMotoDangKy
 */
@DAO(daoClass = LsMotoDangKyDAO.class)
@Caption("{%id}")
@Entity
@Table(name = "LS_MOTO_DANG_KY", schema = "BCA_MOTO")
public class LsMotoDangKy implements java.io.Serializable {

	private LsMotoDangKyId id;
	...
	@AttributeOverrides({
			...
			@AttributeOverride(name = "coThayDoi", column = @Column(name = "CO_THAY_DOI", columnDefinition = "NUMBER", precision = 1, scale = 0)),
			...
			@AttributeOverride(name = "ngayThayDoi", column = @Column(name = "NGAY_THAY_DOI", columnDefinition = "DATE", length = 7)),
	...
	public LsMotoDangKyId getId() {
		return this.id;
	}

	public void setId(LsMotoDangKyId id) {
		this.id = id;
	}

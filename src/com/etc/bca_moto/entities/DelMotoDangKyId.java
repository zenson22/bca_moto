 ...
 */
@Embeddable
public class DelMotoDangKyId implements java.io.Serializable {
	...
	@Column(name = "DUOCPHEP_DIDEN1", columnDefinition = "VARCHAR2", length = 1020)
	public String getDuocphepDiden1() {
		return this.duocphepDiden1;
	}

	public void setDuocphepDiden1(String duocphepDiden1) {
		this.duocphepDiden1 = duocphepDiden1;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DelMotoDangKyId))
			return false;
		DelMotoDangKyId castOther = (DelMotoDangKyId) other;
		...
		return (this.getId() == castOther.getId()) && (this.getMotoId() == castOther.getMotoId())
				...
				&& ((this.getDuocphepDiden1() == castOther.getDuocphepDiden1())
						|| (this.getDuocphepDiden1() != null && castOther.getDuocphepDiden1() != null
								&& this.getDuocphepDiden1().equals(castOther.getDuocphepDiden1())))
	...
	public int hashCode() {
		...
		result = 37 * result + (getDuocphepDiden1() == null ? 0 : this.getDuocphepDiden1().hashCode());

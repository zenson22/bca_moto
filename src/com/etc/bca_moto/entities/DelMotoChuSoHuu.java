...
import com.etc.bca_moto.dal.DelMotoChuSoHuuDAO;
 ...
 * DelMotoChuSoHuu
 */
@DAO(daoClass = DelMotoChuSoHuuDAO.class)
@Caption("{%id}")
@Entity
@Table(name = "DEL_MOTO_CHU_SO_HUU", schema = "BCA_MOTO")
public class DelMotoChuSoHuu implements java.io.Serializable {

	private DelMotoChuSoHuuId id;

	public DelMotoChuSoHuu() {
	}
	...
	public DelMotoChuSoHuuId getId() {
		return this.id;
	}

	public void setId(DelMotoChuSoHuuId id) {
		this.id = id;
	}

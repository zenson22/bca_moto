...
import com.etc.bca_moto.dal.ViewQdtg18Tvtg18DAO;
 ...
 * ViewQdtg18Tvtg18
 */
@DAO(daoClass = ViewQdtg18Tvtg18DAO.class)
@Caption("{%id}")
@Entity
@Table(name = "VIEW_QDTG18_TVTG18", schema = "BCA_MOTO")
public class ViewQdtg18Tvtg18 implements java.io.Serializable {

	private ViewQdtg18Tvtg18Id id;

	public ViewQdtg18Tvtg18() {
	}
	...
	@AttributeOverrides({
			...
			@AttributeOverride(name = "soBienBan18", column = @Column(name = "SO_BIEN_BAN_18", nullable = false, columnDefinition = "NUMBER", precision = 30, scale = 0)),
	...
	public ViewQdtg18Tvtg18Id getId() {
		return this.id;
	}

	public void setId(ViewQdtg18Tvtg18Id id) {
		this.id = id;
	}

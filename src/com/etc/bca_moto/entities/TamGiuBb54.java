...
import com.etc.bca_moto.dal.TamGiuBb54DAO;
 ...
 * TamGiuBb54
 */
@DAO(daoClass = TamGiuBb54DAO.class)
@Caption("{%loaiTvtg}")
@Entity
@Table(name = "TAM_GIU_BB54", schema = "BCA_MOTO")
public class TamGiuBb54 implements java.io.Serializable {

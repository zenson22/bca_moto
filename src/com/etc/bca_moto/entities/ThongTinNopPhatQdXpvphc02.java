...
import com.etc.bca_moto.dal.ThongTinNopPhatQdXpvphc02DAO;
...
/**
 * ThongTinNopPhatQdXpvphc02
 */
@DAO(daoClass = ThongTinNopPhatQdXpvphc02DAO.class)
@Caption("{%id}")
@Entity
@Table(name = "THONG_TIN_NOP_PHAT_QD_XPVPHC_02", schema = "BCA_MOTO")
public class ThongTinNopPhatQdXpvphc02 implements java.io.Serializable {

	private ThongTinNopPhatQdXpvphc02Id id;

	public ThongTinNopPhatQdXpvphc02() {
	}
	...
	public ThongTinNopPhatQdXpvphc02Id getId() {
		return this.id;
	}

	public void setId(ThongTinNopPhatQdXpvphc02Id id) {
		this.id = id;
	}

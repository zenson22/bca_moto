...
import com.etc.bca_moto.dal.QdGiaoQuyen30DAO;
 ...
 * QdGiaoQuyen30
 */
@DAO(daoClass = QdGiaoQuyen30DAO.class)
@Caption("{%soQuyetDinh}")
@Entity
@Table(name = "QD_GIAO_QUYEN_30", schema = "BCA_MOTO")
public class QdGiaoQuyen30 implements java.io.Serializable {
	...
	private String phamViGq;
	private String noiDungGq;
	private String thoiHanGq;
	...
	private String thiHanhTuNgay;

	public QdGiaoQuyen30() {
	}
	...
	@Caption("PhamViGq")
	@Column(name = "PHAM_VI_GQ", columnDefinition = "VARCHAR2", length = 100)
	public String getPhamViGq() {
		return this.phamViGq;
	}

	public void setPhamViGq(String phamViGq) {
		this.phamViGq = phamViGq;
	}

	@Caption("NoiDungGq")
	@Column(name = "NOI_DUNG_GQ", columnDefinition = "VARCHAR2", length = 100)
	public String getNoiDungGq() {
		return this.noiDungGq;
	}
	...
	@Caption("ThoiHanGq")
	@Column(name = "THOI_HAN_GQ", columnDefinition = "VARCHAR2", length = 100)
	public String getThoiHanGq() {
		return this.thoiHanGq;
	}

	public void setThoiHanGq(String thoiHanGq) {
		this.thoiHanGq = thoiHanGq;
	}
	...
	@Caption("ThiHanhTuNgay")
	@Column(name = "THI_HANH_TU_NGAY", columnDefinition = "VARCHAR2", length = 50)
	public String getThiHanhTuNgay() {
		return this.thiHanhTuNgay;
	}

	public void setThiHanhTuNgay(String thiHanhTuNgay) {
		this.thiHanhTuNgay = thiHanhTuNgay;
	}

 ...
 */
@Embeddable
public class BaoCaoThMotoLId implements java.io.Serializable {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BaoCaoThMotoLId))
			return false;
		BaoCaoThMotoLId castOther = (BaoCaoThMotoLId) other;

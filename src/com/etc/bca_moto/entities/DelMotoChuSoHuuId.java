 ...
 */
@Embeddable
public class DelMotoChuSoHuuId implements java.io.Serializable {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DelMotoChuSoHuuId))
			return false;
		DelMotoChuSoHuuId castOther = (DelMotoChuSoHuuId) other;

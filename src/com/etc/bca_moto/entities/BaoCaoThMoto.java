...
import com.etc.bca_moto.dal.BaoCaoThMotoDAO;
 ...
 * BaoCaoThMoto
 */
@DAO(daoClass = BaoCaoThMotoDAO.class)
@Caption("{%id}")
@Entity
@Table(name = "BAO_CAO_TH_MOTO", schema = "BCA_MOTO")
public class BaoCaoThMoto implements java.io.Serializable {

	private BaoCaoThMotoId id;
	...
	public BaoCaoThMotoId getId() {
		return this.id;
	}

	public void setId(BaoCaoThMotoId id) {
		this.id = id;
	}

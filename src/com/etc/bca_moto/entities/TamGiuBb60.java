...
import com.etc.bca_moto.dal.TamGiuBb60DAO;
 ...
 * TamGiuBb60
 */
@DAO(daoClass = TamGiuBb60DAO.class)
@Caption("{%loaiTvtg}")
@Entity
@Table(name = "TAM_GIU_BB60", schema = "BCA_MOTO")
public class TamGiuBb60 implements java.io.Serializable {

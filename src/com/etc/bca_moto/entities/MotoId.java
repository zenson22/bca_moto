 ...
 */
@Embeddable
public class MotoId implements java.io.Serializable {
	...
	private Date kiemtraNgayCapnhat;
	private Date kiemtraNgayTao;
	...
	@Column(name = "KIEMTRA_NGAY_CAPNHAT", columnDefinition = "DATE", length = 7)
	public Date getKiemtraNgayCapnhat() {
		return this.kiemtraNgayCapnhat;
	}

	public void setKiemtraNgayCapnhat(Date kiemtraNgayCapnhat) {
		this.kiemtraNgayCapnhat = kiemtraNgayCapnhat;
	}

	@Column(name = "KIEMTRA_NGAY_TAO", columnDefinition = "DATE", length = 7)
	public Date getKiemtraNgayTao() {
		return this.kiemtraNgayTao;
	}

	public void setKiemtraNgayTao(Date kiemtraNgayTao) {
		this.kiemtraNgayTao = kiemtraNgayTao;
	}

	@Column(name = "TEN_CHUNG_TU", columnDefinition = "VARCHAR2")
	public String getTenChungTu() {
		return this.tenChungTu;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MotoId))
			return false;
		MotoId castOther = (MotoId) other;
		...
		return (this.getId() == castOther.getId())
				...
				&& ((this.getKiemtraNgayCapnhat() == castOther.getKiemtraNgayCapnhat())
						|| (this.getKiemtraNgayCapnhat() != null && castOther.getKiemtraNgayCapnhat() != null
								&& this.getKiemtraNgayCapnhat().equals(castOther.getKiemtraNgayCapnhat())))
				&& ((this.getKiemtraNgayTao() == castOther.getKiemtraNgayTao())
						|| (this.getKiemtraNgayTao() != null && castOther.getKiemtraNgayTao() != null
								&& this.getKiemtraNgayTao().equals(castOther.getKiemtraNgayTao())))
				&& ((this.getTenChungTu() == castOther.getTenChungTu())
						|| (this.getTenChungTu() != null && castOther.getTenChungTu() != null
								&& this.getTenChungTu().equals(castOther.getTenChungTu())));
	}
	...
	public int hashCode() {
		...
		result = 37 * result + (getKiemtraNgayCapnhat() == null ? 0 : this.getKiemtraNgayCapnhat().hashCode());
		result = 37 * result + (getKiemtraNgayTao() == null ? 0 : this.getKiemtraNgayTao().hashCode());
		result = 37 * result + (getTenChungTu() == null ? 0 : this.getTenChungTu().hashCode());
		return result;
	}

...
import com.etc.bca_moto.dal.CanCuQd02DAO;
 ...
 * CanCuQd02
 */
@DAO(daoClass = CanCuQd02DAO.class)
@Caption("{%tenCanCu}")
@Entity
@Table(name = "CAN_CU_QD02", schema = "BCA_MOTO")
public class CanCuQd02 implements java.io.Serializable {

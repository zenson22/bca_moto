...
import com.etc.bca_moto.dal.CanCuQd20DAO;
 ...
 * CanCuQd20
 */
@DAO(daoClass = CanCuQd20DAO.class)
@Caption("{%tenCanCu}")
@Entity
@Table(name = "CAN_CU_QD20", schema = "BCA_MOTO")
public class CanCuQd20 implements java.io.Serializable {

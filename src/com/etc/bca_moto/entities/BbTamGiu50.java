...
import com.etc.bca_moto.dal.BbTamGiu50DAO;
 ...
 * BbTamGiu50
 */
@DAO(daoClass = BbTamGiu50DAO.class)
@Caption("{%soBienBanTg}")
@Entity
@Table(name = "BB_TAM_GIU50", schema = "BCA_MOTO")
public class BbTamGiu50 implements java.io.Serializable {

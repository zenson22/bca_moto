...
import com.etc.bca_moto.dal.ViewBbnptv64Tvtg43DAO;
 ...
 * ViewBbnptv64Tvtg43
 */
@DAO(daoClass = ViewBbnptv64Tvtg43DAO.class)
@Caption("{%id}")
@Entity
@Table(name = "VIEW_BBNPTV64_TVTG43", schema = "BCA_MOTO")
public class ViewBbnptv64Tvtg43 implements java.io.Serializable {

	private ViewBbnptv64Tvtg43Id id;

	public ViewBbnptv64Tvtg43() {
	}
	...
	@AttributeOverrides({
			...
			@AttributeOverride(name = "soBienBanNp", column = @Column(name = "SO_BIEN_BAN_NP", nullable = false, columnDefinition = "VARCHAR2", length = 50)),
			...
			@AttributeOverride(name = "chiuTrachNhiemBq", column = @Column(name = "CHIU_TRACH_NHIEM_BQ", columnDefinition = "VARCHAR2", length = 100)),
	...
	public ViewBbnptv64Tvtg43Id getId() {
		return this.id;
	}

	public void setId(ViewBbnptv64Tvtg43Id id) {
		this.id = id;
	}

...
import com.etc.bca_moto.dal.TamGiuBb43DAO;
 ...
 * TamGiuBb43
 */
@DAO(daoClass = TamGiuBb43DAO.class)
@Caption("{%loaiTvtg}")
@Entity
@Table(name = "TAM_GIU_BB43", schema = "BCA_MOTO")
public class TamGiuBb43 implements java.io.Serializable {

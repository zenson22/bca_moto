...
import com.etc.bca_moto.dal.ViewBbtl60Tvtg60DAO;
 ...
 * ViewBbtl60Tvtg60
 */
@DAO(daoClass = ViewBbtl60Tvtg60DAO.class)
@Caption("{%id}")
@Entity
@Table(name = "VIEW_BBTL60_TVTG60", schema = "BCA_MOTO")
public class ViewBbtl60Tvtg60 implements java.io.Serializable {

	private ViewBbtl60Tvtg60Id id;

	public ViewBbtl60Tvtg60() {
	}
	...
	@AttributeOverrides({
			...
			@AttributeOverride(name = "soBienBanTl", column = @Column(name = "SO_BIEN_BAN_TL", nullable = false, columnDefinition = "VARCHAR2", length = 50)),
			@AttributeOverride(name = "tenCqCapTren", column = @Column(name = "TEN_CQ_CAP_TREN", nullable = false, columnDefinition = "VARCHAR2", length = 100)),
			...
			@AttributeOverride(name = "ngayLapBbTl", column = @Column(name = "NGAY_LAP_BB_TL", nullable = false, columnDefinition = "DATE", length = 7)),
			...
			@AttributeOverride(name = "canCuQuyetDinhTg", column = @Column(name = "CAN_CU_QUYET_DINH_TG", nullable = false, columnDefinition = "VARCHAR2", length = 200)),
			@AttributeOverride(name = "canBoTaoBbTl", column = @Column(name = "CAN_BO_TAO_BB_TL", nullable = false, columnDefinition = "VARCHAR2", length = 50)),
			@AttributeOverride(name = "canBoTaoBbTlId", column = @Column(name = "CAN_BO_TAO_BB_TL_ID", nullable = false, columnDefinition = "NUMBER", precision = 10, scale = 0)),
			...
			@AttributeOverride(name = "soQuyetDinhTgTc", column = @Column(name = "SO_QUYET_DINH_TG_TC", columnDefinition = "NUMBER", precision = 22, scale = 0)),
			@AttributeOverride(name = "ngayQuyetDinhTl", column = @Column(name = "NGAY_QUYET_DINH_TL", columnDefinition = "DATE", length = 7)),
			@AttributeOverride(name = "canBoKyQdTl", column = @Column(name = "CAN_BO_KY_QD_TL", columnDefinition = "VARCHAR2", length = 100)),
			@AttributeOverride(name = "thoiGianLapBbTl", column = @Column(name = "THOI_GIAN_LAP_BB_TL", nullable = false, columnDefinition = "DATE", length = 7)),
			...
			@AttributeOverride(name = "danhSachTvTl", column = @Column(name = "DANH_SACH_TV_TL", columnDefinition = "VARCHAR2", length = 2000)),
			...
			@AttributeOverride(name = "diaDiemTl", column = @Column(name = "DIA_DIEM_TL", columnDefinition = "VARCHAR2", length = 500)),
			...
			@AttributeOverride(name = "soBb20", column = @Column(name = "SO_BB20", columnDefinition = "NUMBER", precision = 10, scale = 0)),
			@AttributeOverride(name = "ngayTaoBb20", column = @Column(name = "NGAY_TAO_BB20", columnDefinition = "DATE", length = 7)),
			...
			@AttributeOverride(name = "soBienBan60", column = @Column(name = "SO_BIEN_BAN_60", nullable = false, columnDefinition = "NUMBER", precision = 30, scale = 0)),
	...
	public ViewBbtl60Tvtg60Id getId() {
		return this.id;
	}

	public void setId(ViewBbtl60Tvtg60Id id) {
		this.id = id;
	}

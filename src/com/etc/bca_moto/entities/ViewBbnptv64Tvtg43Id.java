...
/**
 * ViewBbnptv64Tvtg43Id
 */
@Embeddable
public class ViewBbnptv64Tvtg43Id implements java.io.Serializable {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ViewBbnptv64Tvtg43Id))
			return false;
		ViewBbnptv64Tvtg43Id castOther = (ViewBbnptv64Tvtg43Id) other;

		return (this.getId() == castOther.getId())
				&& ((this.getSoBienBanNp() == castOther.getSoBienBanNp())
						|| (this.getSoBienBanNp() != null && castOther.getSoBienBanNp() != null
								&& this.getSoBienBanNp().equals(castOther.getSoBienBanNp())))
				...
				&& ((this.getChiuTrachNhiemBq() == castOther.getChiuTrachNhiemBq())
						|| (this.getChiuTrachNhiemBq() != null && castOther.getChiuTrachNhiemBq() != null
								&& this.getChiuTrachNhiemBq().equals(castOther.getChiuTrachNhiemBq())))
	...
	public int hashCode() {
		...
		result = 37 * result + (getSoBienBanNp() == null ? 0 : this.getSoBienBanNp().hashCode());
		...
		result = 37 * result + (getChiuTrachNhiemBq() == null ? 0 : this.getChiuTrachNhiemBq().hashCode());

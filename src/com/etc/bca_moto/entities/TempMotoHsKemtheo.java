...
import com.etc.bca_moto.dal.TempMotoHsKemtheoDAO;
 ...
 * TempMotoHsKemtheo
 */
@DAO(daoClass = TempMotoHsKemtheoDAO.class)
@Caption("{%ten}")
@Entity
@Table(name = "TEMP_MOTO_HS_KEMTHEO", schema = "BCA_MOTO")
public class TempMotoHsKemtheo implements java.io.Serializable {

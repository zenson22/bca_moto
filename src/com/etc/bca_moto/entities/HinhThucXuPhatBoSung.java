...
import com.etc.bca_moto.dal.HinhThucXuPhatBoSungDAO;
...
/**
 * HinhThucXuPhatBoSung
 */
@DAO(daoClass = HinhThucXuPhatBoSungDAO.class)
@Caption("{%ma}")
@Entity
@Table(name = "HINH_THUC_XU_PHAT_BO_SUNG", schema = "BCA_MOTO")
public class HinhThucXuPhatBoSung implements java.io.Serializable {
	...
	private Long loaiHinhThuc;
	private Long phanLoaiDuong;
	private Long nghiDinhCpId;

	public HinhThucXuPhatBoSung() {
	}
	...
	@Caption("LoaiHinhThuc")
	@Column(name = "LOAI_HINH_THUC", columnDefinition = "NUMBER", precision = 20, scale = 0)
	public Long getLoaiHinhThuc() {
		return this.loaiHinhThuc;
	}

	public void setLoaiHinhThuc(Long loaiHinhThuc) {

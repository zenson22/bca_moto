...
import com.etc.bca_moto.dal.CanCuBb50DAO;
 ...
 * CanCuBb50
 */
@DAO(daoClass = CanCuBb50DAO.class)
@Caption("{%tenCanCu}")
@Entity
@Table(name = "CAN_CU_BB50", schema = "BCA_MOTO")
public class CanCuBb50 implements java.io.Serializable {
	...
	@Caption("TenCanCu")
	@Column(name = "TEN_CAN_CU", nullable = false, columnDefinition = "VARCHAR2", length = 50)

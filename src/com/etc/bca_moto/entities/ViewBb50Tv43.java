...
import com.etc.bca_moto.dal.ViewBb50Tv43DAO;
 ...
 * ViewBb50Tv43
 */
@DAO(daoClass = ViewBb50Tv43DAO.class)
@Caption("{%id}")
@Entity
@Table(name = "VIEW_BB50_TV43", schema = "BCA_MOTO")
public class ViewBb50Tv43 implements java.io.Serializable {

	private ViewBb50Tv43Id id;
	...
	public ViewBb50Tv43Id getId() {
		return this.id;
	}

	public void setId(ViewBb50Tv43Id id) {
		this.id = id;
	}

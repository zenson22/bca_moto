...
import com.etc.bca_moto.dal.BbBanGiaoTvpt57DAO;
 ...
 * BbBanGiaoTvpt57
 */
@DAO(daoClass = BbBanGiaoTvpt57DAO.class)
@Caption("{%soBienBan}")
@Entity
@Table(name = "BB_BAN_GIAO_TVPT_57", schema = "BCA_MOTO")
public class BbBanGiaoTvpt57 implements java.io.Serializable {

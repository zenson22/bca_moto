...
import com.etc.bca_moto.dal.ViewQd20Tv20DAO;
 ...
 * ViewQd20Tv20
 */
@DAO(daoClass = ViewQd20Tv20DAO.class)
@Caption("{%id}")
@Entity
@Table(name = "VIEW_QD20_TV20", schema = "BCA_MOTO")
public class ViewQd20Tv20 implements java.io.Serializable {

	private ViewQd20Tv20Id id;
	...
	public ViewQd20Tv20Id getId() {
		return this.id;
	}

	public void setId(ViewQd20Tv20Id id) {
		this.id = id;
	}

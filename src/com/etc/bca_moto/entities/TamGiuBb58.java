...
import com.etc.bca_moto.dal.TamGiuBb58DAO;
 ...
 * TamGiuBb58
 */
@DAO(daoClass = TamGiuBb58DAO.class)
@Caption("{%loaiTvtg}")
@Entity
@Table(name = "TAM_GIU_BB58", schema = "BCA_MOTO")
public class TamGiuBb58 implements java.io.Serializable {

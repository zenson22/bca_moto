...
import com.etc.bca_moto.dal.DelMotoDAO;
 ...
 * DelMoto
 */
@DAO(daoClass = DelMotoDAO.class)
@Caption("{%id}")
@Entity
@Table(name = "DEL_MOTO", schema = "BCA_MOTO")
public class DelMoto implements java.io.Serializable {

	private DelMotoId id;
	...
	public DelMotoId getId() {
		return this.id;
	}

	public void setId(DelMotoId id) {
		this.id = id;
	}

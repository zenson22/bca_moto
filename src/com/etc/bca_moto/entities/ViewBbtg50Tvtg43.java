...
import com.etc.bca_moto.dal.ViewBbtg50Tvtg43DAO;
 ...
 * ViewBbtg50Tvtg43
 */
@DAO(daoClass = ViewBbtg50Tvtg43DAO.class)
@Caption("{%id}")
@Entity
@Table(name = "VIEW_BBTG50_TVTG43", schema = "BCA_MOTO")
public class ViewBbtg50Tvtg43 implements java.io.Serializable {

	private ViewBbtg50Tvtg43Id id;

	public ViewBbtg50Tvtg43() {
	}
	...
	public ViewBbtg50Tvtg43Id getId() {
		return this.id;
	}

	public void setId(ViewBbtg50Tvtg43Id id) {
		this.id = id;
	}

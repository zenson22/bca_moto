...
import com.etc.bca_moto.dal.CanCuQd01DAO;
 ...
 * CanCuQd01
 */
@DAO(daoClass = CanCuQd01DAO.class)
@Caption("{%tenCanCu}")
@Entity
@Table(name = "CAN_CU_QD01", schema = "BCA_MOTO")
public class CanCuQd01 implements java.io.Serializable {
